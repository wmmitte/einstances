package bf.gov.application.repository;

import bf.gov.application.EinstancesApp;
import bf.gov.application.config.Constants;
import bf.gov.application.config.audit.AuditEventConverter;
import bf.gov.application.domain.PersistentAuditEvent;
...
import static bf.gov.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
